...
#+begin_src makefile :tangle /dev/shm/boxos/Makefile
  ...
  OBJS += base64.o ring.o lockboard-fsm.o console.o light.o ultraviolet.o camera.o zeropack.o packet.o parameter.o fan.o utility.o card-reader.o card_payload.o upstream-fsm.o upstream.o mt19937.o network.o led.o charger_payload.o charger-packet.o charger-fsm.o charger.o egg_payload.o egg-fsm.o egg.o hash.o uart.o uart4-fsm.o uart4.o uart3_payload.o uart3-packet.o uart3-fsm.o uart3.o
  endif

  CFLAGS += -DZEROPACK_PARAMETER_ENABLED -DZEROPACK_CARD_PAYLOAD_ENABLED -DAPIVERSION=$(APIVERSION) -DZEROPACK_CHARGER_PAYLOAD_ENABLED -DZEROPACK_UART3_PAYLOAD_ENABLED -DZEROPACK_EGG_PAYLOAD_ENABLED
