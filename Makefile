...
release: $(BUILDDIR)/../boxos-fc-ec20-$(MAIN_VERSION).$(SUB_VERSION)-$(DATE).bin $(BUILDDIR)/../boxos-fc-esp8266-$(MAIN_VERSION).$(SUB_VERSION)-$(DATE).bin $(BUILDDIR)/../boxos-dgzl-ec20-$(MAIN_VERSION).$(SUB_VERSION)-$(DATE).bin $(BUILDDIR)/../boxos-dgzl-esp8266-$(MAIN_VERSION).$(SUB_VERSION)-$(DATE).bin

$(BUILDDIR)/../boxos-fc-ec20-$(MAIN_VERSION).$(SUB_VERSION)-$(DATE).bin: $(BUILDSRC) $(CARDREADERSRC) $(CONSOLESRC) $(CORESRC) $(CHARGERSRC) $(DRIVERSRC) $(EGGSRC) $(LOCKSRC) $(NETWORKSRC) $(UTILITYSRC) $(LEXFSMSRC) $(CHARGERFSMSRC) $(EC20FSMSRC) $(EC20SYNTAXFSMSRC) $(EGGFSMSRC) $(ENGINEERFSMSRC) $(ESP8266FSMSRC) $(ESP8266SYNTAXFSMSRC) $(LOCKBOARDFSMSRC) $(LOCKFCFSMSRC) $(UART3FSMSRC) $(UART4FSMSRC) $(UPSTREAMFSMSRC) $(CHARGERPROTOSCR) $(UART3PROTOSCR) $(LIBRARY) $(CONFIGSRC)
...
ifdef ENGINEER_MODE
	...
	cd $(BUILDDIR); make clean; make bin; cp boxos.bin $@; cd -

$(BUILDDIR)/../boxos-fc-esp8266-$(MAIN_VERSION).$(SUB_VERSION)-$(DATE).bin: $(BUILDSRC) $(CARDREADERSRC) $(CONSOLESRC) $(CORESRC) $(CHARGERSRC) $(DRIVERSRC) $(EGGSRC) $(LOCKSRC) $(NETWORKSRC) $(UTILITYSRC) $(LEXFSMSRC) $(CHARGERFSMSRC) $(EC20FSMSRC) $(EC20SYNTAXFSMSRC) $(EGGFSMSRC) $(ENGINEERFSMSRC) $(ESP8266FSMSRC) $(ESP8266SYNTAXFSMSRC) $(LOCKBOARDFSMSRC) $(LOCKFCFSMSRC) $(UART3FSMSRC) $(UART4FSMSRC) $(UPSTREAMFSMSRC) $(CHARGERPROTOSCR) $(UART3PROTOSCR) $(LIBRARY) $(CONFIGSRC)
...
$(BUILDDIR)/../boxos-dgzl-ec20-$(MAIN_VERSION).$(SUB_VERSION)-$(DATE).bin: $(BUILDSRC) $(CARDREADERSRC) $(CONSOLESRC) $(CORESRC) $(CHARGERSRC) $(DRIVERSRC) $(EGGSRC) $(LOCKSRC) $(NETWORKSRC) $(UTILITYSRC) $(LEXFSMSRC) $(CHARGERFSMSRC) $(EC20FSMSRC) $(EC20SYNTAXFSMSRC) $(EGGFSMSRC) $(ENGINEERFSMSRC) $(ESP8266FSMSRC) $(ESP8266SYNTAXFSMSRC) $(LOCKBOARDFSMSRC) $(LOCKDGZLFSMSRC) $(UART3FSMSRC) $(UART4FSMSRC) $(UPSTREAMFSMSRC) $(CHARGERPROTOSCR) $(UART3PROTOSCR) $(LIBRARY) $(CONFIGSRC)
...
$(BUILDDIR)/../boxos-dgzl-esp8266-$(MAIN_VERSION).$(SUB_VERSION)-$(DATE).bin: $(BUILDSRC) $(CARDREADERSRC) $(CONSOLESRC) $(CORESRC) $(CHARGERSRC) $(DRIVERSRC) $(EGGSRC) $(LOCKSRC) $(NETWORKSRC) $(UTILITYSRC) $(LEXFSMSRC) $(CHARGERFSMSRC) $(EC20FSMSRC) $(EC20SYNTAXFSMSRC) $(EGGFSMSRC) $(ENGINEERFSMSRC) $(ESP8266FSMSRC) $(ESP8266SYNTAXFSMSRC) $(LOCKBOARDFSMSRC) $(LOCKDGZLFSMSRC) $(UART3FSMSRC) $(UART4FSMSRC) $(UPSTREAMFSMSRC) $(CHARGERPROTOSCR) $(UART3PROTOSCR) $(LIBRARY) $(CONFIGSRC)
